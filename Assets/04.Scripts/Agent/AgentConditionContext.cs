...
namespace ZZZ.Agent
{
    ...
    // CharacterActionRunner에 ILinkConditionContext로 주입된다. 몬스터는 별도 컨텍스트를 구현해 주입한다.
    public sealed class AgentConditionContext : ILinkConditionContext
    {
        private readonly AgentMotor _motor;
        private readonly Transform _transform;
        private readonly AgentActionController _controller;

        public AgentConditionContext(
            AgentMotor motor, Transform transform, AgentActionController controller)
        {
            _motor = motor;
